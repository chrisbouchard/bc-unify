...
\begin{enumerate}[(i)]
    ...
    \item $U \ueq f(V_1, \dotsc, V_n)$, where $U$ and $V_1$ through $V_n$ are
        variables and $f$ is a function symbol with the appropriate arity (with
        respect to number and sorts of its arguments)
\end{enumerate}
...
Currently there is at least one attack on cypher block chaining in the wild.
