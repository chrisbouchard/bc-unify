...
developed at the Naval Research Lab. Maude-NPA uses term-rewriting and algebraic
properties to analyze cryptographic protocols at a symbolic level.

For our implementation, we chose the language Maude\footnote{The Maude System:
\url{http://maude.cs.uiuc.edu/}}, which is a popular rewriting-based
programming language. Tools such as Maude-NPA\footnote{Maude-NPA:
\url{http://maude.cs.uiuc.edu/tools/Maude-NPA/}} take advantage of Maude's
powerful reflective and symbolic capabilities. More details about the language
will be given in Section~\ref{section:maude}.
